...
const TalentProfile: React.FC<TalentProfileProps> = ({ talentId, onClose }) => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      try {
        ...
        NotificationSystem.showErrorMessage('Failed to send message. Please try again.');
      }
    }
  };
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      NotificationSystem.showErrorMessage('Failed to update favorites. Please try again.');
    }
  };
  ...
  const handleAddToShortlist = (projectId: string) => {
    ...
    if (success) {
      ...
      loadTalentStats();
      loadTalentNotifications();
      NotificationSystem.showSuccessMessage(`${talent.name} has been added to your shortlist for ${projectTitle}!`);
    } else {
      NotificationSystem.showErrorMessage('Failed to add talent to shortlist. Please try again.');
    }
  };
