...
const TalentProfile: React.FC<TalentProfileProps> = ({ talentId, onClose }) => {
  ...
  const handleSaveProfile = () => {
    ...
    if (!isClient) {
      alert('Only clients can save talent profiles.');
      return;
    }
  ...
  const handleAddToProjectClick = () => {
    ...
    if (!isClient) {
      alert('Only clients can add talent to projects.');
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-slate-900 py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
            ...
            <div className="flex flex-col gap-3">
              ...
              {isAuthenticated && isClient ? (
                // Buttons for authenticated clients
                <>
                  <button 
        ...
        {/* Contact Modal - Only for authenticated clients */}
        {showContactModal && isAuthenticated && isClient && (
        ...
        {/* Project Shortlist Modal - Only for authenticated clients */}
        {showShortlistModal && isAuthenticated && isClient && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-slate-800 rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-gray-700">
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
